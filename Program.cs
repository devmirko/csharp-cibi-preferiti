...
//for (int i = 1; i < numeriSomma.Length; i += 2)
//{
...
string parolaUno = Console.ReadLine();

string parolaDue = Console.ReadLine();

ComparaParola(parolaUno, parolaDue);

void ComparaParola(string item1, string item2) {
...
void Stampa(string item)
{
    Console.WriteLine(item);
}

void Compara(string item1, string item2)
{
    if (item1.Length > item2.Length)
    {
